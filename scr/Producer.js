...
connection.on("ProducerCreated", (producer) => {
    fetchProducers(); // Refetch producers after a new one is created
});
connection.on("ProducerUpdated", (producer) => {
    fetchProducers(); // Refetch producers after a new one is created
});
connection.on("ProducerDeleted", (producer) => {
    fetchProducers(); // Refetch producers after a new one is created
});
